                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(10),
                          image: DecorationImage(
                              image: AssetImage('images/codechefSquare.jpg'))),
                    )
                  ],
                ),
                SizedBox(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(
                              color:
                                  ColorSchemeClass.atcodergrey.withOpacity(0.5),
                              width: 2),
                          boxShadow: [
                            BoxShadow(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(
                              color: ColorSchemeClass.spojblue.withOpacity(0.5),
                              width: 2),
                          boxShadow: [
                            BoxShadow(
                                color:
                                    ColorSchemeClass.spojblue.withOpacity(0.2),
                                offset: Offset(0,
                                    MediaQuery.of(context).size.height * 0.007))
                          ],
                          borderRadius: BorderRadius.circular(10),
